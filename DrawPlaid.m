...
try
    ...
    [x,y] = meshgrid(-texsize:texsize+p, -texsize:texsize + p);
    ...
    while vbl < vblendtime
        ...
        srcRectx=[xoffset 0 xoffset + visiblesize visiblesize];
        srcRecty=[0 yoffset visiblesize yoffset + visiblesize];
        % Draw grating texture, rotated by "angle":
        Screen('DrawTexture', w, gratingtex, srcRectx, dstRect, 0);
        Screen('DrawTexture', w, gratingtex, srcRecty, dstRect, 0 );
        if drawmask==1
            % Draw gaussian mask over grating:
            Screen('DrawTexture', w, masktex, [0 0 visiblesize visiblesize], dstRect, 0);
        end
